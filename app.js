...
const home=()=>`<section class="sheet left" data-number="01"><p class="eyebrow">A LITTLE ABOUT ME</p><figure class="paper-photo"><img src="assets/fashion-cover.png" alt="时尚日记项目资料中的服装店画面"><figcaption>a little world of fashion</figcaption><span class="photo-tag">我的项目剪贴</span></figure><div class="note"><p class="note-title">Hi，我是大花。</p><ul class="quickfacts"><li><b>坐标</b>上海</li><li><b>经历</b>6 年产品与游戏策划</li><li><b>关注</b><span>C端用户体验、女性成长、AI、跨境出海</span></li><li><b>教育</b>天津师范大学 · 计算机本科</li></ul></div><div class="ink-links"><a href="assets/Monica-Liu-Resume.pdf">阅读简历 ↗</a><a href="https://www.xiaohongshu.com/user/profile/5bba2fd06b58b7085597ae5b" rel="noreferrer" referrerpolicy="no-referrer">我的小红书 ↗</a></div></section><section class="sheet right" data-number="02"><p class="intro-label">Hello, curious minds.</p><h1>读懂女性需求，<br>用<em>游戏化设计</em><br>推动增长。</h1><p class="intro-body">我擅长发掘 C 端用户的真实需求，尤其关注女性在穿搭、消费与自我表达中的体验。</p><p class="intro-body">结合游戏化设计，把需求转化为让用户愿意参与、持续使用并做出购买选择的产品。</p><div class="home-keywords"><span>跨境电商</span><span>游戏化设计</span><span>AI Agent 产品</span></div><div class="stamp">STAY CURIOUS · KEEP MAKING</div></section>`;
...
const contact=()=>sheet('left',9,`<p class="eyebrow">A NOTE TO YOU</p>${title('嗨，很高兴认识你。','A curious mind, a maker at heart.')}<div class="contact-letter"><p class="letter-body">我是大花，一个脑洞很多、也喜欢把问题拆开解决的 INTJ。擅长本地化调研，喜欢观察不同地方的人怎样生活、怎样做选择。</p><p class="letter-body">从游戏、跨境电商到 AI 应用，我一直好奇：人们真正需要什么？一个产品，又凭什么让人愿意留下来？</p><p class="letter-body">科技爱好者，AI 重度用户。想法可以天马行空，也想亲手把它们做出来。我相信科技和审美能改变未来。</p><p class="letter-body">希望一直保有这份好奇，和优秀的团队一起成长，做出有趣、有意义、能给人带来正向影响的产品。如果你也在做这样的事，来聊聊呀。</p></div><p class="signature">大花 / Monica</p>`)+sheet('right',10,`<p class="eyebrow">KEEP IN TOUCH</p>${title('来聊聊吧。','Good things start with a hello.')}<div class="contact-directory"><div class="contact-card"><span>手机号 / PHONE</span><p class="contact-value">13012248198</p></div><div class="contact-card"><span>邮箱 / EMAIL</span><p class="contact-value">lxhcrystal233@163.com</p></div><div class="contact-card"><span>微信 / WECHAT</span><p class="contact-value">zxnlxh</p></div><div class="contact-card"><span>小红书 / XIAOHONGSHU</span><a href="${xhs}" rel="noreferrer" referrerpolicy="no-referrer">我的小红书主页 ↗</a></div></div><div class="resume-note contact-resume"><h3>也可以带走我的简历</h3><a class="solid-link" href="assets/Monica-Liu-Resume.pdf">打开 PDF 简历 ↗</a></div><button class="text-button" data-go="home">再翻回第一页 ↶</button>`);
